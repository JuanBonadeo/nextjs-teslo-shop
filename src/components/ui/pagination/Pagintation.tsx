...
export const Pagintation = ({ totalPages }: Props) => {
...

                    {
                        allPages.map(page => (
                            <li className="page-item" key={page}>
                                <Link 
                                    className={
                                        clsx( 'page-link relative block py-1.5 px-3 rounded border-0 outline-none transition-all duration-300 text-gray-800 hover:text-gray-800 hover:bg-gray-400 focus:shadow-none',
